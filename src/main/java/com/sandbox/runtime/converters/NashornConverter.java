...
public class NashornConverter {
    ...
    private Object convert(Global global, Object object) throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, ClassNotFoundException {
        ...
        }else if(object == null || object.getClass().isPrimitive() || object instanceof String || object instanceof Number || object instanceof Boolean || object instanceof Byte || object instanceof Character  || object.getClass().getCanonicalName().startsWith("jdk.")){
            return object;
        }else{
