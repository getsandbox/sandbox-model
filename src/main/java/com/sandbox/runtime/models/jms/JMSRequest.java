...
public class JMSRequest extends EngineRequest {
    ...
    public JMSRequest(ScriptEngine scriptEngine, ObjectMapper mapper, String destination, Map<String, String> headers, Map<String, String> properties, Object body, String contentType, String ip) throws Exception {
        super(scriptEngine, mapper, headers, properties, body, contentType, ip);
