...
public abstract class EngineRequest {
    ...
    public EngineRequest(ScriptEngine scriptEngine, ObjectMapper mapper, Map<String, String> headers,
        ...
        if (body != null && !body.toString().isEmpty()) {
            try {
                if ("json".equalsIgnoreCase(this.contentType)) {
                    ...
                    parsedBody = NashornConverter.instance().convert(scriptEngine, JSONUtils.parse(mapper, (String) body));
                    ...
                    parsedBody = decodeBody((String) body);
