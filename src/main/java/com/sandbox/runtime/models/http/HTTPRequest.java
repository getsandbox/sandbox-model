...
public class HTTPRequest extends EngineRequest {
    ...
    public HTTPRequest(ScriptEngine scriptEngine, ObjectMapper mapper, String path, String method, Map<String, String> headers,
    ...
    public RuntimeResponse _getErrorResponse(com.sandbox.runtime.models.Error error){
